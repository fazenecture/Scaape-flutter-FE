                                ...
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    image: DecorationImage(
                                        image: AssetImage('images/pink-back.png'),
                                        fit: BoxFit.fill),
                                    boxShadow: [
                                      BoxShadow(
                                          blurRadius: 25,
                                          color: Color(0xFFFF4B2B).withOpacity(0.43),
                                          spreadRadius: 7)
                                    ],
                                  ),
                                ...
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    boxShadow: [
                                      BoxShadow(
                                          blurRadius: 25,
                                          color: Color(0xFFFF416C).withOpacity(0.2),
                                          spreadRadius: 7)
                                    ],
                                  ),
                                  child: CircleAvatar(
                                    ...
                                    child: CircleAvatar(
                                      backgroundImage:
                                      NetworkImage('${stringmani(currentUser!.photoURL) }'),
